class UserValidator {
  static validateSignUp(req, res, next) {
    ...
    if (!req.body.email) {
      ...
      validationMessage += 'password cannot contain only spaces. mix with other characters';
    } else if (req.body.password.trim().length < 5) {
      validationMessage += 'password must include minimum of 5 characters';
    ...
    } else if (req.body.address.length < 20) {
      validationMessage += 'Address must be greater than 20 characters.';
    }
